namespace Tempore.Tests.Tempore.Processing.PayDay.Services.WorkforceMetricCalculators
{
    ...
    public class TardanzaNOpagadaWorkforceMetricCalculatorFacts
    {
        public class The_CalculateDailySnapshot_Method
        {
            ...
            public async Task Computes_Expected_Values_Async(ScheduledDay scheduledDay, double expectedValue)
            {
                ...
                var workforceMetricCalculator = new TardanzaNOpagadaWorkforceMetricCalculator(NullLogger<TardanzaNOpagadaWorkforceMetricCalculator>.Instance, workforceMetricRepositoryMock.Object);
