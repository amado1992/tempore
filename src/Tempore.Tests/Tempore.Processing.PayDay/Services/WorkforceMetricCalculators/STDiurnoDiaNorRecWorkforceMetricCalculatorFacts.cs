namespace Tempore.Tests.Tempore.Processing.PayDay.Services.WorkforceMetricCalculators
{
    ...
    public class STDiurnoDiaNorRecWorkforceMetricCalculatorFacts
    {
        public class The_CalculateDailySnapshot_Method
        {
            ...
            public async Task Computes_Expected_Values_Async(ScheduledDay scheduledDay, double expectedValue)
            {
                ...
                var workforceMetricCalculator = new STDiurnoDiaNorRecWorkforceMetricCalculator(NullLogger<STDiurnoDiaNorRecWorkforceMetricCalculator>.Instance, workforceMetricRepositoryMock.Object);
